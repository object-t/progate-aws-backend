...
class TestCostCalculation:
    ...
    def test_find_resource_types_simple(self):
        """シンプルなリソースタイプ抽出のテスト"""
        struct_data = {"type": "ec2", "name": "web-server"}
    ...
    def test_calculate_final_cost_monthly_only(self):
        ...
        costs_db = {"ec2": {"cost": "10.50", "type": "per_month"}}
        num_requests = 1000
    ...
    def test_calculate_final_cost_request_only(self):
        ...
        costs_db = {"lambda": {"cost": "0.0001", "type": "per_request"}}
        num_requests = 10000
    ...
    def test_calculate_final_cost_mixed(self):
        ...
        struct_data = {"web": {"type": "ec2"}, "api": {"type": "lambda"}}
        costs_db = {
    ...
    def test_calculate_final_cost_unknown_resource(self):
        ...
        costs_db = {"ec2": {"cost": "10.00", "type": "per_month"}}
        num_requests = 1000
...
class TestCostAPI:
    ...
    def test_calculate_cost_no_data(self, mock_table):
        ...
        request_data = {"struct_data": {"type": "ec2"}, "num_requests": 1000}
...
class TestEdgeCases:
    ...
    def test_calculate_final_cost_with_string_costs(self):
        """コストが文字列の場合のテスト"""
        struct_data = {"type": "ec2"}
        costs_db = {"ec2": {"cost": "25.99", "type": "per_month"}}
        num_requests = 1000
